...
export function ReplayTimelinePlayback({ className }: ReplayTimelinePlaybackProps): JSX.Element {
  ...
  return (
    <div
      aria-live="polite"
      className={"text-xs font-mono uppercase tracking-widest text-textMuted " + (className ?? "")}
    >
      {summary}
    </div>
  );
